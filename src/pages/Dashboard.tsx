    ...
    return (
        <>
            ...
            <div className="mt-[60px] xl:block">
                <Container>
                    <div className='flex flex-col md:flex-row md:pt-10 pt-3 text-center pb-6 mb-[40px]'>
                        <div className="md:w-[25%] md:min-w-[380px]">
                            ...
                            <div className="flex md:flex-col items-center md:justify-start justify-center gap-2 md:mt-[60px] mt-[35px]">
                                ...
                                <h1 className='md:text-4xl text-[1.8em]' onClick={() => setOpen(!open)}>$ {balance.toFixed(2)}</h1>
                ...
                <div className='w-full pb-1 fixed bg-white bottom-0 left-0'>
                    <Container>
